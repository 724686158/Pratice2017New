...
public class GoodDao {
    ...
    public Good findAddress(long good_id) {
    ...
    public void addGood(long good_id,
        ...
        jdbc.update("INSERT INTO good(good_id,good_name,good_price,imageurl,discount,good_description) VALUE (?, ?, ?, ?, ?, ?, ?)", good_id,good_name,good_price,imageurl,discount,good_description);
    }
    ...
    public void modifyGood(long good_id,
                           ...
                           double discount,
                           String good_description) {
        jdbc.update("UPDATE good SET  good_name = ? AND good_price = ? AND imageurl = ? And discount = ? AND good_description = ? WHERE good_id = ?",
    ...
    public class GoodRowMapper implements RowMapper<Good> {
        ...
        public Good mapRow(ResultSet rs, int rowNum) throws SQLException {
          ...
          good.setDiscount(rs.getDouble("discout"));
            return good;
        }
    }
}
